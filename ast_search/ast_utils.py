...
def get_module_name(file_path, node, working_path):
    ...
    if node.level > 0:
        relative_path = "." * node.level + os.path.sep + (node.module if node.module else "")
    else:
...
if __name__ == '__main__':
    ...
    # print(py_files)
    print(convert_dotted_name(repo_path, r'/home/lanbo/repo/test_repo/file1/file2.py')[1])
    print(module_name_to_path(convert_dotted_name(repo_path, r'/home/lanbo/repo/test_repo/file1/file2.py')[1], repo_path))
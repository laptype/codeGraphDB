...
import ast_search.utils as apputils
...
def parse_python_file(file_full_path: str) -> Optional[tuple[list, dict, list]]:
    """
    ...
    for node in ast.walk(tree):
        if isinstance(node, ast.ClassDef):
            ...
            classes.append((class_name, start_lineno, end_lineno, base_classes))
